...
<Project DefaultTargets="Build" ToolsVersion="14.0" xmlns="http://schemas.microsoft.com/developer/msbuild/2003">
  ...
  <PropertyGroup Label="Globals">
    <ProjectGuid>{3D4DDF01-914B-8068-4C18-27EE3A4113A0}</ProjectGuid>
  ...
  <ItemGroup>
    <CustomBuild Include="$(OutDir)\node_sqlite3.node">
      ...
      <Command>call mkdir &quot;C:\Users\user\offchain-data-storage-system\node_modules\sqlite3\lib\binding\node-v83-win32-x64&quot; 2&gt;nul &amp; set ERRORLEVEL=0 &amp; copy /Y &quot;$(OutDir)node_sqlite3.node&quot; &quot;C:\Users\user\offchain-data-storage-system\node_modules\sqlite3\lib\binding\node-v83-win32-x64\node_sqlite3.node&quot;&#xD;&#xA;if %errorlevel% neq 0 exit /b %errorlevel%</Command>
      <Message>Copying $(OutDir)/node_sqlite3.node to C:/Users/user/offchain-data-storage-system/node_modules/sqlite3/lib/binding/node-v83-win32-x64\node_sqlite3.node</Message>
      <Outputs>C:\Users\user\offchain-data-storage-system\node_modules\sqlite3\lib\binding\node-v83-win32-x64\node_sqlite3.node</Outputs>
    </CustomBuild>
  </ItemGroup>
  <ItemGroup>
    <ProjectReference Include="node_sqlite3.vcxproj">
      <Project>{75D4D85C-03FA-62CD-1391-F153153AE7B1}</Project>
